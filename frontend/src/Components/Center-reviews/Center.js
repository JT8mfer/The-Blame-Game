...
class Center extends React.Component {
    state = {
        centerItems:[
            ...
            {id:3, name:"Hitman3", date:"January 28, 2021", description:"HITMAN 3 is the dramatic conclusion to the World of Assassination trilogy and takes players around the world on a globetrotting adventure to sprawling sandbox locations. Agent 47 returns as a ruthless professional for the most important contracts of his entire career.", centerimage:hitman3},
            {id:4, name:"Grindstone", date:"December 12, 2020", description:"Smash creeps to get huge combos and earn precious Grindstones in CAPY’s hit puzzle-battler. Cash in your grindstones to craft new gear and overcome devious enemies, obstacles, and boss encounters as you conquer Grindstone Mountain’s 200+ levels, and prove your prowess on the daily mode’s leaderboards.", centerimage:grindstone},
            {id:5, name:"Omori", date:"November 27, 2020", description:"Explore a strange world full of colorful friends and foes. When the time comes, the path you’ve chosen will determine your fate... and perhaps the fate of others as well.", centerimage:omori}
        ]
    }
    render() {
